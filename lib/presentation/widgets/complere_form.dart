...
class ComplereForm extends ConsumerWidget {
    ...
    return ConstrainedBox(
      ...
      child: DecoratedBox(
        decoration: BoxDecoration(
          ...
          color: const Color.fromRGBO(64, 64, 64, 0.86),
          boxShadow: const [
            BoxShadow(
          ...
          child: Column(
            ...
            children: [
              TextField(
                ...
                onChanged: (value) =>
                    ref.read(formNomenProvider.notifier).state = value,
              ...
              /// COLOR BUTTON (muestra el color elegido)
              Column(
  ...
  void _onFormSubmit(WidgetRef ref) {
    final String nameValue =
        ref.read(formNomenProvider.notifier).state; // CORRECTO
